  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-between h-full">
        <div className="h-auto">
          <ul className=" cursor-pointer space-y-3 h-auto mt-4">
            ...
            <li className="cursor-pointer mx-6 border rounded bg-gray-500 h-11">
              ...
              >
                <TbRouteSquare className={"size-5"} />
                {isExpanded ? <span>Routes</span> : ""}
              </Link>
            </li>
            <li className="cursor-pointer mx-6 border rounded bg-gray-500 h-11">
              <Link
                ...
                onClick={() => setSelectedOption("Routes")}
              >
                <MdInventory className={"size-5"} />
                {isExpanded ? <span>Inventary</span> : ""}
              </Link>
            </li>
            <li className="cursor-pointer mx-6 border rounded bg-gray-500 h-11">
              <Link
        ...
        <div className="pb-8">
          <button
            onClick={() => setExpandeState(!isExpanded)}
